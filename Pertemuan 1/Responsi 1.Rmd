...
# Membaca file Excel
data_excel <- read_excel("D:\\KULIAHH\\SEMESTER 6\\ASPRAK ANREG\\Data excel mainan pertemuan 1.xlsx")
(dataa <- read_xlsx("D:\\KULIAHH\\SEMESTER 6\\ASPRAK ANREG\\Data excel mainan pertemuan 1.xlsx"))
```

### b. **CSV**
```{r}
# Membaca file CSV
data_csv <- read.csv("D:/KULIAHH/SEMESTER 6/ASPRAK ANREG/Data csv mainan pertemuan 1.csv")
dataaa <- read.csv2("D:/KULIAHH/SEMESTER 6/ASPRAK ANREG/Data csv mainan pertemuan 1.csv")
```
